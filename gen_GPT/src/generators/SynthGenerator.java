...
public class SynthGenerator extends AbstractGenerator implements GPTGenerator {
    ...
    // probability for plan don't have subGoal(only contain action)
    ...
    public HashMap<String, Literal> genEnvironment(){
        ...
        for (int i = 0; i < num_var; i++) {
            ...
            // randomInit wei true,chansheng de xml wenjian zhong initVal de zhi wei Random ,xu yu du XML wenjian xiang pipei
    ...
    private PlanNode createPlan(int depth, ArrayList<Literal> as, ArrayList<Literal> prec, ArrayList<Literal> gcs, boolean leave){
        ...
        ArrayList<TreeNode> planbody = new ArrayList<>();
